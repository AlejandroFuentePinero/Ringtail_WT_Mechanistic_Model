#' endoR_devel_green - the development version of the endotherm model of NicheMapR 
#'  for green ringtail possums based on data collected by Krockenberger et al.
#'
#' Load parameters using the WetTropicsPossums/scripts/green_ringtail_parameters.R
#' 
#' 
...
endoR_devel_f2 <- function(
  ...
  RQ = 0.74, # respiratory quotient (fractional, 0-1)
  ...
  while(QGEN < QBASAL){ #Allow to be within 1% of basal
    ...
    # call the subroutine
    GEOM.out <- GEOM_ENDO(AMASS, ANDENS, FATPCT, SHAPE, ZFUR, SUBQFAT, SHAPE_B, SHAPE_C, DHARA, RHOARA, PCOND, SAMODE, ORIENT)
