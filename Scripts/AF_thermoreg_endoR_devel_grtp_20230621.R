#' endoR_devel - the development version of the endotherm model of NicheMapR adapted for Green ringtail possums by NB and AF
#'
...
endoR_devel_grtp <- function(
  ...
  while(QGEN < QBASAL){
    ...
    if (THERMOREG != 0) {
      ...
      # This process can happen simultaneously with other processes
      ...
      # Uncurl
      if ((SHAPE_B < SHAPE_B_MAX) & (UNCURL > 0)) {
